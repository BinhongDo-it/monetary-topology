...
#: Levels excluded from the floor test, ruled 2026-08-16: a
...
def report(res, res_flex_cohort, q_same, names) -> str:
    ...
    A("**A blank class field and a self-reported unknown code are both "
      "excluded, each carrying its count.** Neither is an agent "
